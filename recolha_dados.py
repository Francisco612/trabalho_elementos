...
ab = pd.read_csv("csv_analise/386.csv", encoding="utf-8", sep=",")
ds = pd.read_csv("csv_analise/439.csv", encoding="utf-8", sep=",")
...
# Guarda o resultado
df_merged.to_csv("resultados_csv/data_final.csv", index=False, sep=";", encoding='utf-8-sig')
