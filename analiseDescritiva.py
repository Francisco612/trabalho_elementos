...
# manter só a modalidade com maior taxa de desistência
...
# Juntar essa modalidade com mais desitencia com os outros dados
...
# Identificar top 3 municipios mais extremos
mais_desemprego = pca_df.nlargest(3, 'Desemprego_jovens')
menos_desemprego = pca_df.nsmallest(3, 'Desemprego_jovens')
mais_desistencia = pca_df.nlargest(3, 'Desistencia_total')
menos_desistencia = pca_df.nsmallest(3, 'Desistencia_total')
